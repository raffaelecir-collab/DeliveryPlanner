...
var SCHEMA = {
  ...
  INTERVENTI: {
    ...
    fields: [
      ...
      { key: 'rapportoOraInizio', label: 'Rapporto - Ora Inizio (HH:mm)', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento" (tab "La mia squadra"), non modificabile da qui.' },
      { key: 'rapportoOraFine', label: 'Rapporto - Ora Fine (HH:mm)', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento" (tab "La mia squadra"), non modificabile da qui.' },
      { key: 'rapportoArticoli', label: 'Rapporto - Articoli (JSON)', type: 'text', readonly: true, help: 'Elenco (JSON) di Cod. Articolo/Q.tà/Consegnato/Ritirato/Descrizione compilato dalla squadra tramite "Rapporto di Intervento". Non modificabile da qui.' },
      ...
      { key: 'rapportoTempoTrasferimentoOre', label: 'Rapporto - Tempo Trasferimento Andata (ore)', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento", non modificabile da qui.' },
      { key: 'rapportoTempoTrasferimentoMinuti', label: 'Rapporto - Tempo Trasferimento Andata (minuti)', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento", non modificabile da qui.' },
      ...
      { key: 'rapportoTempoTrasferimentoRitornoOre', label: 'Rapporto - Tempo Trasferimento Ritorno (ore)', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento", non modificabile da qui.' },
      { key: 'rapportoTempoTrasferimentoRitornoMinuti', label: 'Rapporto - Tempo Trasferimento Ritorno (minuti)', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento", non modificabile da qui.' },
      { key: 'rapportoTecnicoNome', label: 'Rapporto - Tecnico (nome e cognome)', type: 'text', readonly: true, help: 'Precompilato col nome della Squadra, modificabile dalla squadra tramite "Rapporto di Intervento".' },
      { key: 'rapportoTecnicoCod', label: 'Rapporto - Cod. Tecnico', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento", non modificabile da qui.' },
      { key: 'rapportoCliente', label: 'Rapporto - Intervenuto presso il Cliente', type: 'text', readonly: true, help: 'Precompilato dal Cliente dell\'intervento, modificabile dalla squadra tramite "Rapporto di Intervento" (solo ai fini del PDF: non aggiorna il campo Cliente dell\'intervento).' },
      { key: 'rapportoTelefono', label: 'Rapporto - Telefono', type: 'text', readonly: true, help: 'Precompilato dal Telefono dell\'intervento, modificabile dalla squadra tramite "Rapporto di Intervento" (solo ai fini del PDF).' },
      { key: 'rapportoIndirizzo', label: 'Rapporto - Indirizzo', type: 'text', readonly: true, help: 'Precompilato dall\'Indirizzo dell\'intervento, modificabile dalla squadra tramite "Rapporto di Intervento" (solo ai fini del PDF).' },
      { key: 'rapportoComune', label: 'Rapporto - Comune', type: 'text', readonly: true, help: 'Precompilato dal Comune dell\'intervento, modificabile dalla squadra tramite "Rapporto di Intervento" (solo ai fini del PDF).' },
      { key: 'rapportoProvincia', label: 'Rapporto - Prov.', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento", non modificabile da qui.' },
      { key: 'rapportoTipoImpianto', label: 'Rapporto - Tipo d\'impianto', type: 'text', readonly: true, help: 'Compilato dalla squadra tramite "Rapporto di Intervento", non modificabile da qui.' },
      { key: 'rapportoCodEquipment', label: 'Rapporto - Cod. Equipment', type: 'text', readonly: true, help: 'Precompilato dal Cod. Equipment dell\'intervento, modificabile dalla squadra tramite "Rapporto di Intervento" (solo ai fini del PDF).' },
      { key: 'rapportoCausale', label: 'Rapporto - Causale dell\'intervento', type: 'text', readonly: true, help: 'Precompilato dal Tipo Attività dell\'intervento, modificabile dalla squadra tramite "Rapporto di Intervento".' },
      { key: 'rapportoRichiestoDa', label: 'Rapporto - Richiesto da', type: 'text', readonly: true, help: 'Precompilato con "Cristiano Damiani" (Tipo Attività SM01) o "Sara Baran" (altrimenti), modificabile dalla squadra tramite "Rapporto di Intervento".' },
      { key: 'rapportoInData', label: 'Rapporto - In data', type: 'text', readonly: true, help: 'Precompilato dalla Data Dispacciamento dell\'intervento, modificabile dalla squadra tramite "Rapporto di Intervento".' },
      { key: 'rapportoNumeroOrdine', label: 'Rapporto - N° ordine', type: 'text', readonly: true, help: 'Precompilato dal Codice Esterno dell\'intervento, modificabile dalla squadra tramite "Rapporto di Intervento" (solo ai fini del PDF).' },
      { key: 'rapportoRegime', label: 'Rapporto - Regime dell\'intervento', type: 'text', readonly: true, help: 'Precompilato con "Ordinario", modificabile dalla squadra tramite "Rapporto di Intervento" tra le opzioni del modulo cartaceo (Ordinario/In reperibilità/In garanzia/A pagamento/Contratto o assistenza).' }
    ]
  },
  REGOLE: {
